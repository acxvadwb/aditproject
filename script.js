...
window.addEventListener('load', () => {
    bgMusic.volume = 0.8;  // Set volume to 80%
    bgMusic.play().catch(console.log);
});

const messages = [
    {
        text: "maapin yaa mohon?",
        image: "img2.jpg"
    },
    {
        text: "mau yaa cantikk><",
        image: "img1.jpg"
    },
    {
        text: "kalau tetep gamau, aku\"gapapa\" dehh <3",
        image: "img.jpg"
    }
];
...
yesBtn.addEventListener('click', () => {
    title.innerHTML = "yeayyy akhirnya mauuuu lopyuuu <3";
    document.querySelector('img').src = "cute.gif";
...
noBtn.addEventListener('click', () => {
    if (noCount < 3) {
        ...
        title.innerHTML = "TIDAK BISAA HUUUUUUU";
